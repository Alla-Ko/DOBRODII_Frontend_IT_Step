...
@Component({
  selector: 'app-primary-large-orange-button-with-border',
  standalone: true,
  ...
  template: `
    <button
      ...
      class="flex items-center justify-center gap-2 w-full 
			h-12 rounded-40 p-4 uppercase pr-10 pl-10 
			font-inter font-bold text-base 
    bg-primary-orange text-primary-beige
		hover:bg-primary-beige hover:text-primary-orange  hover:border-2 hover:border-primary-orange
...
export class PrimaryLargeOrangeButtonWithBorderComponent {
