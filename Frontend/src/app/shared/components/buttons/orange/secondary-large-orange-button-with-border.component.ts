...
@Component({
  selector: 'app-secondary-large-orange-button-with-border',
  standalone: true,
  ...
  template: `
    ...
    active:bg-secondary-treePoppy-1 active:text-primary-light-orange 
...
export class SecondaryLargeOrangeButtonWithBorderComponent {
