...
export class AnimalAidRequestService {
  ...
  //   slug: string
  // ): Observable<AnimalAidRequest | undefined> {
  //   const found = this.mockAnimalAidRequests.find(x => x.slug === slug);
